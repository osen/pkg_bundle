...
void process(const char *path)
{
  ...
  replace("/usr/local/share/icu/72.1", "share/icu/72.1");
...
int main()
{
  process("lib/libicudata.so.22.0");
  process("lib/libicui18n.so.22.0");
  process("lib/libicuio.so.22.0");
  process("lib/libicutest.so.22.0");
  process("lib/libicutu.so.22.0");
  process("lib/libicuuc.so.22.0");
